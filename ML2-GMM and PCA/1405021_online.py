...
def dyna_plot(x, prob):
    ...
    black = []
    for m in range(0, len(x)):
        if prob[m][0] > prob[m][1] and prob[m][0] > prob[m][2] and prob[m][0] > prob[m][3]:
            green.append(x[m])
        elif prob[m][1] > prob[m][0] and prob[m][1] > prob[m][2] and prob[m][1]> prob[m][3]:
            blue.append(x[m])
        elif prob[m][2] > prob[m][0] and prob[m][2] > prob[m][1] and prob[m][2] > prob[m][3]:
            red.append(x[m])
        else:
            black.append(x[m])
